...
export class RegisterComponent implements OnInit {
	...
	constructor(private http: HttpClient, private router: Router, private m: DataModelManagerService) {
	...
	sendEmail(userName: string): Observable<Credentials> {
		return this.http.post<any>(`${this.url}/api/sendmail`, userName);
	}
	...
	create(credentials: Credentials): Observable<any> {
		return this.http.post<any>(`${this.url}/api/users/register`, credentials);
	}
}
