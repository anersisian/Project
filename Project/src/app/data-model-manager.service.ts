...
export class DataModelManagerService {
	...
	usersUpdateSubscriptionInfo(_id: string, value: any): Observable<any> {
		...
		return this.http
			.put<any>(`${this.url}/api/users/${_id}/updateSubscriptionInfo`, value, this.httpOptions)
			.pipe(
				tap((value: any) => console.log({ message: 'Updated subscription info' })),
	...
	usersUpdatePastDeliveries(_id: string, value: any): Observable<any> {
		console.log('update called   ' + value);
		return this.http
			.put<any>(`${this.url}/api/users/${_id}/updatePastDeliveries`, value, this.httpOptions)
			.pipe(
				tap((value: any) => console.log({ message: 'Updated past deliveries' })),
				catchError(this.handleError<any>('update'))
			);
	}
	...
	userPhoneUpdate(_id: string, value: any): Observable<any> {
		console.log('update called   ' + value);
		return this.http
			.put<any>(`${this.url}/api/users/${_id}/phone`, value, this.httpOptions)
			.pipe(
				tap((value: any) => console.log({ message: 'Updated' })),
				catchError(this.handleError<any>('update'))
			);
	}
	//Subscription Update
	...
	subscriptionsUpdate(_id: string, value: Subscriptions): Observable<any> {
		return this.http
			.put<any>(`${this.url}/api/subscriptions/${_id}`, value, this.httpOptions)
			.pipe(
				tap((value: Subscriptions) => console.log({ message: 'Updated' })),
				catchError(this.handleError<any>('update'))
			);
	}
	//Sub Get One
